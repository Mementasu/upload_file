...
<body id="preview">
    <div class="frame">
        ...
        <form class="form" action="regist_preview.php" method="POST">
            <div class="preview">
...
<?php
            ...
            try {
                ...
                // 仮登録
                $sql2 = "UPDATE `2021_team-b_user` SET email=:email, name=:name, street_number=:street_number, street_address1=:street_address1, street_address2=:street_address2, street_address3=:street_address3, phone_number=:phone_number WHERE id=:id";
...
<body id="preview">
    <div class="frame">
        ...
        <form class="form" action="level_select.php" method="POST">
            <p>登録できた</p>
            <p class="btn-preview">
                <input class="btn-preview-edit" type="submit" name="trans_level_select" value="難易度選択画面">
            </p>
        </form>
    </div>
